...
describe('useNoteActions', () => {
  it('initialize loads notes from service', async () => {
    // the mocked noteService is told via the mockResolvedValue 
    // function how it should behave in the context of the test
    ...
    // the completion of the call must be awaited with the await keyword
    await act(async () => {
